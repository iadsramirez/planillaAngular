...
export class PlantillaDosComponent implements OnInit {
  ...
  guardarAccionTemplate2() {
    ...
    if (this.fechaInicioAplica) {
      ...
      accionPersonal.fechaInicial = String(this.fechaInicioAplica.year) + '-' + mes + String(this.fechaInicioAplica.month) + '-' + String(this.fechaInicioAplica.day);
    ...
    if (this.fechaInicio) {
      ...
      accionPersonal.periodo = this.fechaInicio.year + '-' + mes2 + this.fechaInicio.month + '-' + this.fechaInicio.day;
    ...
    if (this.fechaFinAplica) {
      ...
      accionPersonal.fechaFinal = this.fechaFinAplica.year + '-' + mes3 + this.fechaFinAplica.month + '-' + this.fechaFinAplica.day;
    }
    ...
    if (this.fechaFin) {
      ...
      accionPersonal.periodoFinal = this.fechaFin.year + '-' + mes4 + this.fechaFin.month + '-' + this.fechaFin.day;
